...
const theme = createTheme({
  ...
  palette: {
    text: {
      ...
      secondary: '#0034ac', // Secondary Text Color
    },
    background: {
      default: '#FFFFFF', // Default Background Color
    },
    primary: {
      main: '#0034ac', // Document Main Primary Color
      ...
      box_show_blog: '#0034ac21', //Box Shadow Blog Section
      ...
      HeroGradient: 'linear-gradient(to right, #FFF , #0034ac42)', // Gradient (Hero Section)
      WorkGradient: 'linear-gradient(to right, #0034ac42, #FFF)', // Gradient (Portfolio Section)
      ContactGradient: 'linear-gradient(to right, #0034ac42, #FFFFFF4A)', // Gradient (Contact Section)
    },
  },
  breakpoints: {
    values: {
